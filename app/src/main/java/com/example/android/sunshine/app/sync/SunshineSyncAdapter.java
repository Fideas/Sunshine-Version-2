...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        //For more information on how to get an API key please visit http://openweathermap.org/appid
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        try {
            ...
            if (locationCursor.moveToFirst()) {
                ...
                Uri returnedUri = getContext().getContentResolver().insert(
                        WeatherContract.LocationEntry.CONTENT_URI,
                        values);
                locationId = ContentUris.parseId(returnedUri);
            }
        } finally {
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    //Create an intent for what to open
                    Intent resultIntent = new Intent(context, MainActivity.class);
                    //Create backstack
                    TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);
                    //Add intent
                    stackBuilder.addNextIntent(resultIntent);
                    PendingIntent detailedPendingIntent = stackBuilder.getPendingIntent(
                            0,
                            PendingIntent.FLAG_UPDATE_CURRENT
                    );
                    builder.setContentIntent(detailedPendingIntent);
